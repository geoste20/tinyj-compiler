...
private static void expr1() throws SourceFileErrorException {
    ...
    switch (getCurrentToken()) {
        ...
        // Unsigned integer literals or null
        case UNSIGNEDINT: 
			accept(UNSIGNEDINT);
            break;
        case NULL:
        ...
        // Identifier: IDENT ( . nextInt() | [<argumentList>] { '[' <expr3> ']' } )
case IDENT:
    accept(IDENT);
    ...
    break;
        default: 
        throw new SourceFileErrorException( "Malformed expression, unexpected token: ");
    }
